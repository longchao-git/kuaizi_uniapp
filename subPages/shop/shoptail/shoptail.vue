...
<script>
	...
	export default {
		...
		onShareAppMessage: function() {
			app.globalData.share('微信小程序外卖', '/subPages/shop/shoptail/shoptail?id=' + shop_id);
		},
		methods: {
			getStaticQrcode() {
			...
			//去领取优惠券页
			toGetCoupon() {
				app.globalData.topage('/subPages/activity/getcoupon/getcoupon?shop_id=' + shop_id);
			},
			...
			toorder: function() {
				app.globalData.topage('/pages/order/order', 'tab');
			},
			tocenter: function() {
				app.globalData.topage('/pages/mine/mine', 'tab');
			},
			...
			onShareTimeline: function() {
				app.globalData.shareimeline('微信小程序外卖', '/subPages/shop/shoptail/shoptail?id=' + shop_id);
			},
