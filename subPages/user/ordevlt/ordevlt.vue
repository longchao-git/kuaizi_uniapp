...
<script>
	...
	export default {
		...
		onLoad: function(e) {
			...
			that.pei_time = shu
			that.score = '3'
			that.score_peisong = '3'
			that.shop_starPct = '100'
			that.peisong_starPct = '100'
		},
		...
		methods: {
			...
			chooseImage: function() {
				...
				uni.chooseImage({
					...
					success: function(res) {
						...
						that.imageList_len = newImageList.length
			...
			removeImage: function(e) {
				...
				this.imageList_len = imageList.length
